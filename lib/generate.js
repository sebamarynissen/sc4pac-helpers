...
// # transform(json)
// Transforms the generated metadata. This is useful if we know that certain 
// creators have a specific way of doing it.
function transform(json) {

	// If we're dealing with jasoncw and a CAMelot, we have to add exclude 
	// patterns to the non-cam versions.
	if (json.group === 'jasoncw') {
